...
function [Dist,D,k,w,rw,tw] = func_DTW_3D(handle_in, XYZ, num_beat_1, num_beat_2, start_point, end_point, axes_dtw, show_path)
...
[Dist,D,k,w,rw,tw] = dtw(sign_1,sign_2, show_path);
